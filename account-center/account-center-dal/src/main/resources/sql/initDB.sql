...
-- 拆分表 路由规则：account_no的头两位
CREATE TABLE IF NOT EXISTS `account`(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '物理主键',
  `account_no` varchar(8) not null COMMENT '账户号,唯一标示',
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT '防悬挂';
-- 记录每一笔分布式事务操作的账号、操作金额，TCC模式下才会使用到此表
